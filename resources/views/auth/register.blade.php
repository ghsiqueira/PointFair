...
<body>
    <x-guest-layout>
        <x-authentication-card>
            ...
            <form method="POST" action="{{ route('register') }}" onsubmit="return validateTerms()">
                @csrf
                ...
                <div class="mt-4">
                    <x-label for="terms">
                        <div class="flex items-center">
                            ...
                            <div class="ml-2">
                                {!! __('Estou de acordo com os :terms_of_service e com a :privacy_policy.', [
    ...
    <script src="public\build\assets\app-b9a1a811.js"></script>
</body>
</html>